...
response = get('https://courses.cs.washington.edu/courses/cse312/24sp/calendar/calendar.html')
...
base_url = "https://courses.cs.washington.edu/courses/cse312/24sp/"
...
with open("CSE312_24sp_lecture.json", "w") as file:
