...
response = get('https://courses.cs.washington.edu/courses/cse332/24sp/calendar/calendar.html')
...
base_url = "https://courses.cs.washington.edu/courses/cse332/24sp/"
...
with open("CSE332_24sp_lecture.json", "w") as file:
