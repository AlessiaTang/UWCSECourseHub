...
response = get('https://courses.cs.washington.edu/courses/cse417/24wi/calendar/calendar.html')
...
base_url = "https://courses.cs.washington.edu/courses/cse417/24wi/"
...
with open("CSE417_24wi_lecture.json", "w") as file:
