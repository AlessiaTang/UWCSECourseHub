...
response = get('https://courses.cs.washington.edu/courses/cse333/24sp/calendar/calendar.html')
...
base_url = "https://courses.cs.washington.edu/courses/cse333/24sp/"
...
with open("CSE333_24sp_lecture.json", "w") as file:
