...
response = get('https://courses.cs.washington.edu/courses/cse312/23sp/calendar/calendar.html')
...
base_url = "https://courses.cs.washington.edu/courses/cse312/23sp/"
...
with open("CSE312_23sp_lecture.json", "w") as file:
